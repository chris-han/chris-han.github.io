...
首先通过Microsoft Power Platform提供现场工作人员移动警报推送，提示体温异常人员通过检测点。Push notification是通过Microsoft Flow(现在改名叫Power Automate)实现。推送的Notification又可以打开移动设备上的Power App（补一张图3）。
